...
class TextService:
    ...
    def get_button(self, key: str, language: str) -> str:
        return self._buttons.get(language, {}).get(key, "")

    def get_language_button(self, key: str) -> str:
        return self._language_buttons.get(key, "")
    ...
    @property
    def language_buttons(self) -> Dict:
